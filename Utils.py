#Based on: https://github.com/deepak112/Keras-SRGAN/blob/master/Utils.py
...
def load_data_from_dirs(dirs, ext, number_of_images):
    files = []
    file_names = []
    count = 0
    for d in dirs:
        for f in os.listdir(d):
            if f.endswith(ext):
                ...
                count = count + 1
                print(str(count) + '/' + str(number_of_images) + ' images')
